...
for i in range(1, 30):
    ...
    for chrom in range(1, 22):
        ...
        gb_clf = GradientBoostingClassifier(learning_rate=0.01, n_estimators=100,max_depth=4, min_samples_split=2, min_samples_leaf=1, subsample=1,max_features='sqrt', random_state=10)
